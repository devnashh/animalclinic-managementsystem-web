document.addEventListener("DOMContentLoaded", function () {
  const archivedBookingsTable = document.getElementById(
  ...
  const viewArchivedBookingsModal = document.getElementById(
    "viewArchivedBookingsModal"
  );
  viewArchivedBookingsModal.addEventListener(
    "show.bs.modal",
