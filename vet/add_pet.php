                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="petWeight" name="weight" class="form-control" />
                                </div>
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 text-center">
                                        <div class="position-relative">
                                            <img src="../media/pet_images/avatar.avif" alt="Pet"
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            editPetModal.addEventListener('show.bs.modal', function (event) {
                ...
                const petWeight = button.closest('tr').children[4].textContent.trim();
                ...
                this.querySelector('#petWeight').value = petWeight;
            });
        });
    </script>
