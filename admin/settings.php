...
<div class="offcanvas offcanvas-start d-md-none" id="sidebarMenu">
    ...
    <div class="offcanvas-body d-flex flex-column align-items-center">
        ...
        <a href="home.php" class="text-dark active d-flex align-items-center py-2 px-3 rounded w-100">
...
<div class="sidebar d-none d-md-flex flex-column align-items-center p-3">
    ...
    <div class="container mt-3" style="font-family: 'Nunito', sans-serif;">
        <h1 class="mb-3">Admin Settings</h1>
        ...
        <?php endif; ?>
        <?php if (isset($_GET['success_user']) && $_GET['success_user'] == 1): ?>
            <div class="alert alert-success alert-dismissible fade show" role="alert">
                User restored successfully.
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>
        <?php elseif (isset($_GET['error_user'])): ?>
        ...
        <div class="profile-card mb-5">
            ...
            <div class="d-flex align-items-center mb-3">
                <i class="bi bi-person-gear text-primary me-3" style="font-size: 3.5rem;"></i>
                <div>
                    <h5 class="mb-0"><?php echo htmlspecialchars($admin_details['full_name']); ?></h5>
                    <p class="text-muted mb-0"><em><?php echo htmlspecialchars($admin_details['role']); ?></em></p>
                </div>
            </div>
            <hr>
            ...
            <?php if (!empty($admin_details)): ?>
                <div class="text-start">
                    <p><strong>Contact:</strong> <?php echo htmlspecialchars($admin_details['contact_number']); ?></p>
                    ...
                    <p><strong>Role:</strong> <?php echo htmlspecialchars($admin_details['role']); ?></p>
                </div>
        ...
        <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="php/update_admin_info.php" method="POST">
                        <div class="modal-body">
                            <div class="mb-3">
                                <label for="contact_number" class="form-label">Contact Number</label>
                                <input type="text" class="form-control" id="contact_number" name="contact_number"
                                    value="<?php echo htmlspecialchars($admin_details['contact_number']); ?>" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="address" name="address" rows="2"
                                    required><?php echo htmlspecialchars($admin_details['address']); ?></textarea>
                            </div>
        ...
        <!-- Delete All Data Statistics -->
        <div class="mb-3 mt-5">
            <button class="btn btn-danger d-flex align-items-center" onclick="deleteAllStatistics()">
                <i class="bi bi-trash-fill me-2"></i> Delete All Data Statistics
            </button>
        </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <button type="button" class="btn btn-danger" id="deleteAllBtn">Delete All Archived
                            Bookings</button>
                    </div>
                </div>
            </div>
        ...
        <div class="modal fade" id="viewArchivedUsersModal" tabindex="-1" aria-labelledby="viewArchivedUsersModalLabel"
            aria-hidden="true">
        ...
        <script>
            document.getElementById("DeleteAllBtn").addEventListener("click", function () {
                if (confirm("Are you sure you want to delete all users except 'dev_nash'? This action cannot be undone!")) {
                    // Send AJAX request
                    var xhr = new XMLHttpRequest();
                    xhr.open("POST", "php/delete_all_archived_users.php", true);
        ...
        <script>
            document.getElementById("deleteAllBtn").addEventListener("click", function () {
                if (confirm("Are you sure you want to delete all archived users? This action cannot be undone!")) {
                    // AJAX request to delete records
                    var xhr = new XMLHttpRequest();
                    xhr.open("POST", "php/delete_all_bookings.php", true);
                    xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
