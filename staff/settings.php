...
<body class="d-flex">
    ...
    <div class="sidebar d-flex flex-column align-items-center p-3">
        ...
        <div class="admin-info text-dark mt-3 text-center">
            <i class="bi bi-person-badge me-1" style="font-size: 1.5em"></i>
            <div>
        ...
        <h1 class="mb-3">Veterinarian Settings</h2>
            <div class="profile-card mb-5">
                ...
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div>
                        <h5 class="mb-0"><?php echo htmlspecialchars($staff_details['username']); ?></h5>
                        <p class="text-muted mb-0"><em><?php echo htmlspecialchars($staff_details['role']); ?></em></p>
                    </div>
                </div>
                ...
                <?php if (!empty($staff_details)): ?>
                    <div class="text-start">
                        <p><strong>Contact:</strong> <?php echo htmlspecialchars($staff_details['contact_number']); ?></p>
                        <p><strong>Email:</strong> <?php echo htmlspecialchars($staff_details['email']); ?></p>
                        <p><strong>Address:</strong> <?php echo htmlspecialchars($staff_details['address']); ?></p>
                        <p><strong>Role:</strong> <?php echo htmlspecialchars($staff_details['role']); ?></p>
                    </div>
